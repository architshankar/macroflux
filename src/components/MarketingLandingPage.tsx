...
export function MarketingLandingPage({ onLaunchAdmin }: MarketingLandingPageProps) {
  ...
  // Barbell/Treadmill volume simulation state
  const [treadmillActive, setTreadmillActive] = useState<boolean>(false);
  const [treadmillSpeed, setTreadmillSpeed] = useState<number>(11.5); // km/h
  const [treadmillDistance, setTreadmillDistance] = useState<number>(3.45); // km
  const [treadmillTime, setTreadmillTime] = useState<number>(1042); // seconds
  ...
  return (
    <div className="bg-[#0D0D0D] min-h-screen text-white font-sans relative overflow-hidden bg-grid selection:bg-[#CCFF00] selection:text-black">
      ...
      <header className="border-b border-[#1C1C1C] bg-[#0D0D0D]/80 backdrop-blur-md sticky top-0 z-50 px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="w-8 h-8 rounded-lg bg-linear-to-tr from-black to-[#1A1A1A] border border-[#CCFF00]/50 flex items-center justify-center p-1 relative overflow-hidden">
              <span className="text-[#CCFF00] font-black text-xs font-mono group-hover:scale-110 transition-transform">MF</span>
              <div className="absolute inset-0 bg-[#CCFF00]/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
            <div>
              <span className="font-display font-bold text-base sm:text-lg tracking-wider bg-linear-to-r from-white to-[#BFBFBF] bg-clip-text text-transparent">MACRO</span>
              <span className="font-display font-black text-base sm:text-lg tracking-wider text-[#CCFF00] text-glow">FLUX</span>
            </div>
          </div>
          
          <nav className="hidden lg:flex items-center space-x-8 text-sm font-medium text-[#9A9A9A]">
            <a href="#features" className="hover:text-[#CCFF00] transition-colors">Overload Grid</a>
            <a href="#biometrics" className="hover:text-[#CCFF00] transition-colors">Kinetic Tonnage Core</a>
            <a href="#pricing" className="hover:text-[#CCFF00] transition-colors">Tiers</a>
          </nav>
      ...
      <section className="relative pt-12 sm:pt-20 pb-16 sm:pb-24 px-4 sm:px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16 z-10">
        ...
        <div className="flex-1 text-center lg:text-left w-full">
          <div className="inline-flex items-center space-x-2 bg-[#141414] border border-[#252525] rounded-full px-3 py-1 mb-6">
            <span className="w-1.5 h-1.5 bg-[#CCFF00] rounded-full animate-ping"></span>
            <span className="text-[10px] sm:text-[11px] font-mono tracking-widest text-[#9A9A9A] uppercase">MacroFlux Progressive Hypertrophy Engine v2.4</span>
          </div>

          <h1 className="font-display font-extrabold text-3xl sm:text-5xl lg:text-6xl tracking-tight leading-tight mb-6">
            Total Volume Strategy.<br />
            <span className="text-glow bg-linear-to-r from-[#CCFF00] to-[#E6FF80] bg-clip-text text-transparent">Frictionless</span> Overload Tracking.
          </h1>

          <p className="text-sm sm:text-base lg:text-lg text-[#9A9A9A] font-light max-w-xl mx-auto lg:mx-0 mb-8 leading-relaxed">
            Eliminate operational friction in the weight room. Audit historical execution parameters instantly with focused in-app sheets. Isolate warmups, plot dynamic weekly training volume charts, and log sets securely with top-set overload preservation.
          </p>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-6 mt-12 pt-8 border-t border-[#1C1C1C] max-w-lg mx-auto lg:mx-0">
            <div>
              <div className="font-mono text-[#CCFF00] text-base sm:text-lg font-bold">0ms</div>
              <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-[#9A9A9A] mt-1">Focus Drift</div>
            </div>
            <div>
              <div className="font-mono text-white text-base sm:text-lg font-bold">100%</div>
              <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-[#9A9A9A] mt-1">TTV Accountability</div>
            </div>
            <div>
              <div className="font-mono text-white text-base sm:text-lg font-bold">Resilient</div>
              <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-[#9A9A9A] mt-1">Background Timers</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 w-full max-w-lg relative block group">
          <div className="absolute inset-0 bg-linear-to-tr from-[#CCFF00]/10 to-transparent rounded-2xl filter blur-xl opacity-30 group-hover:opacity-60 transition-opacity"></div>
          ...
          <div className="relative bg-[#141414] border-2 border-[#252525] rounded-2xl p-4 sm:p-6 shadow-2xl glass-box overflow-hidden">
            <div className="flex items-center justify-between border-b border-[#252525]/80 pb-4 mb-5">
              ...
              <div className="font-mono text-[10px] text-[#9A9A9A] bg-[#1F1F1F] px-2 py-0.5 rounded-md border border-[#2D2D2D] flex items-center gap-1.5">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></div>
                <span>HUD LOCK: ACTIVE WORKOUT STATE</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              {/* Widget 1: Caloric Nutrition Target */}
              <div className="bg-[#0D0D0D] border border-[#252525] rounded-xl p-4 flex items-center justify-between relative overflow-hidden">
                <div className="space-y-1">
                  <span className="text-[11px] font-mono tracking-widest text-[#9A9A9A] block uppercase">METABOLIC STRATEGY BUDGET</span>
                  <span className="text-xl font-display font-extrabold text-white">{calorieBudget.toLocaleString()} kcal</span>
                </div>
                <div className="text-right">
                  <span className="text-[10px] font-mono text-[#CCFF00] bg-[#CCFF00]/10 border border-[#CCFF00]/30 px-2 py-0.5 rounded-full">MACRO FLUX</span>
                  <span className="text-xs text-[#9A9A9A] block mt-1 font-mono">{protein}p / {carbs}c / {fats}f</span>
                </div>
                <div className="absolute top-0 right-0 w-24 h-full pointer-events-none opacity-20">
                  <svg viewBox="0 0 100 100" className="w-full h-full text-[#CCFF00]">
              ...
              {/* Widget 2: Heart rate & rest timer telemetry */}
              <div className="bg-[#0D0D0D] border border-[#252525] rounded-xl p-4">
                <div className="flex justify-between items-center mb-3">
                  <div className="flex items-center space-x-2">
                    <Heart className="w-4 h-4 text-red-500 animate-pulse" />
                    <span className="text-[11px] font-mono text-[#9A9A9A] uppercase tracking-wider">REST PERIOD TICKER (BACKGROUND SAFE)</span>
                  </div>
                  <span className="font-mono text-xs font-semibold text-[#CCFF00]">01:28 REMAINING</span>
                </div>
              ...
              <div className="bg-[#0D0D0D] border border-[#252525] rounded-xl p-4">
                <div className="flex justify-between items-center mb-3">
                  <div className="flex items-center space-x-2">
                    <Activity className="w-4 h-4 text-[#CCFF00]" />
                    <span className="text-[11px] font-mono text-[#9A9A9A] uppercase tracking-wider">LIVE WORKOUT STREAMING</span>
                  </div>
                  <button 
                    onClick={() => setTreadmillActive(!treadmillActive)}
                    className={`font-mono text-[10px] px-2.5 py-1 rounded-md border flex items-center gap-1 transition-all ${
                  ...
                  >
                    {treadmillActive ? <Pause className="w-2.5 h-2.5"/> : <Play className="w-2.5 h-2.5"/>}
                    <span>{treadmillActive ? 'PAUSE WORKOUT' : 'SIMULATE REPS'}</span>
                  </button>
                </div>
                
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="bg-[#141414] rounded-lg p-2.5 border border-[#202020]">
                    <span className="text-[9px] font-mono text-[#9A9A9A] uppercase tracking-wider block">CURRENT SET</span>
                    <span className="text-sm font-mono font-bold text-white text-glow">Set 3 / 4</span>
                  </div>
                  <div className="bg-[#141414] rounded-lg p-2.5 border border-[#202020]">
                    <span className="text-[9px] font-mono text-[#9A9A9A] uppercase tracking-wider block">PRESCRIBED REPS</span>
                    <span className="text-sm font-mono font-bold text-white"> reps</span>
                  </div>
                  <div className="bg-[#141414] rounded-lg p-2.5 border border-[#202020]">
                    <span className="text-[9px] font-mono text-[#9A9A9A] uppercase tracking-wider block">LAST LOGGED</span>
                    <span className="text-sm font-mono font-bold text-[#CCFF00]">140 kg</span>
                  </div>
                </div>
              </div>
            ...
            <View style={{ height: 1 }} className="mt-5 pt-4 border-t border-[#252525]/80 flex items-center justify-between text-xs text-[#9A9A9A] font-mono">
              <span>SUPABASE SYNC STATUS: RESPONSIVE FOCUS</span>
              <span>MUTATION DONE</span>
            </View>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center md:text-left mb-16 md:flex md:items-end md:justify-between">
            <div className="max-w-xl">
              <span className="text-xs font-mono text-[#CCFF00] uppercase tracking-widest font-semibold block mb-2">BENTO COMPONENT SUITE</span>
              <h2 className="font-display font-bold text-3xl sm:text-4xl tracking-tight text-white mb-4">
                Engineered for Total Volume Sovereignty.
              </h2>
              <p className="text-[#9A9A9A] text-sm sm:text-base leading-relaxed">
                Take command of absolute mechanical progression bounds, compound target presets, and workout tracking lifecycle streams within an optimized zero-friction framework layout.
              </p>
            </div>
            <div className="mt-6 md:mt-0 flex justify-center md:justify-start">
              <span className="text-xs font-mono text-[#9A9A9A] border border-[#252525] bg-[#141414] px-4 py-2 rounded-lg inline-flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-[#CCFF00] rounded-full"></span> Instantly loads past tracked notes contextually per set.
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            {/* Bento Card 1: Interactive Caloric Budget Slider Panel */}
            <div className="md:col-span-7 bg-[#141414] border border-[#252525] rounded-xl p-5 sm:p-8 flex flex-col justify-between transition-all hover:border-[#CCFF00]/40 group relative overflow-hidden">
              ...
              <div>
                <div className="flex items-center space-x-2 text-glow mb-4">
                  <Apple className="w-5 h-5 text-[#CCFF00]" />
                  <span className="text-xs font-mono tracking-widest uppercase text-[#CCFF00]">Dynamic Strategy Mapping</span>
                </div>
                <h3 className="text-xl font-display font-medium text-white mb-2">High-Fidelity Nutrition Architecture</h3>
                <p className="text-sm text-[#9A9A9A] leading-relaxed max-w-md mb-8">
                  Tune target energy constraints seamlessly. Adjust dynamic macro boundaries to automatically coordinate fueling targets matching high-volume workout requirements.
                </p>
              </div>
              ...
              <div className="bg-[#0D0D0D] border border-[#252525] rounded-lg p-4 sm:p-5 space-y-5">
                <div className="flex justify-between items-center border-b border-[#1A1A1A] pb-3">
                  <span className="text-xs font-mono text-[#9A9A9A] uppercase tracking-wider">Dynamic Intake Target</span>
                  <div className="text-right">
                    <span className="text-lg font-mono font-extrabold text-[#CCFF00]">{calorieBudget}</span>
                    <span className="text-[10px] font-mono text-[#9A9A9A] ml-1">KCAL / DAY</span>
                  </div>
            ...
            {/* Bento Card 2: Dynamic Workout Strength Logging */}
            <div className="md:col-span-5 bg-[#141414] border border-[#252525] rounded-xl p-5 sm:p-8 flex flex-col justify-between transition-all hover:border-[#CCFF00]/40 group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-36 h-36 bg-pink-500/5 rounded-full blur-3xl pointer-events-none"></div>
              ...
              <div>
                <div className="flex items-center space-x-2 text-glow mb-4">
                  <Dumbbell className="w-5 h-5 text-[#CCFF00]" />
                  <span className="text-xs font-mono tracking-widest uppercase text-[#9A9A9A]">Total Training Volume</span>
                </div>
                <h3 className="text-xl font-display font-medium text-white mb-2">Automated Progressive Overload</h3>
                <p className="text-sm text-[#9A9A9A] leading-relaxed mb-6">
                  Audit true training tonnage history instantly. Track execution velocity benchmarks from past records to ensure mechanical advantage adaptations are consistently checked.
                </p>
              </div>

              {/* Workout Stat Mockup */}
              <div className="bg-[#0D0D0D] border border-[#252525] rounded-lg p-4 sm:p-5">
                <div className="font-mono text-[10px] text-zinc-500 mb-2">REAL-TIME INLINE SET PROGRESSION</div>
                <div className="flex items-center justify-between border-b border-[#1A1A1A] pb-3 mb-3">
                  <div>
                    <span className="text-sm text-white font-bold block">Barbell Squat Series</span>
                    <span className="text-[10px] font-mono text-[#9A9A9A]">Target Level: Working Set</span>
                  </div>
                  <div className="text-right">
                    <span className="text-xs font-mono text-glow text-[#CCFF00] font-bold block">160 kg</span>
                    <span className="text-[10px] font-mono text-[#9A9A9A]">Logged: 3 / 4 Sets</span>
                  </div>
                </div>

                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono text-[#9A9A9A]">Session Volume Tonnage</span>
                  <span className="text-[#CCFF00] font-mono text-sm font-bold">1,920 kg</span>
                </div>

                {/* Inline Segmented Progress Bar Fill Tracker */}
                <div className="mt-4 flex h-1.5 w-full bg-[#1A1A1A] rounded-full overflow-hidden border border-[#252525]">
                  <div className="h-full w-[75%] bg-[#CCFF00] rounded-full"></div>
                </div>
              </div>
            </div>

            {/* Bento Card 3: In-App Preset Notes & Warmup Isolation */}
            <div className="md:col-span-5 bg-[#141414] border border-[#252525] rounded-xl p-5 sm:p-8 flex flex-col justify-between transition-all hover:border-[#CCFF00]/40 group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-36 h-36 bg-emerald-500/5 rounded-full blur-3xl pointer-events-none"></div>
              ...
              <div>
                <div className="flex items-center space-x-2 text-glow mb-4">
                  <Timer className="w-5 h-5 text-[#CCFF00]" />
                  <span className="text-xs font-mono tracking-widest uppercase text-[#9A9A9A]">Frictionless Input</span>
                </div>
                <h3 className="text-xl font-display font-medium text-white mb-2">Execution Presets & Isolation</h3>
                <p className="text-sm text-[#9A9A9A] leading-relaxed mb-6">
                  Gated layout lifecycles allow unlimited warmup set entry without inflating working volume metrics. Append performance trackers instantly with horizontal quick-fill notes chips.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                <div className="bg-[#0D0D0D] border border-[#252525] rounded-lg p-2.5 sm:p-3">
                  <span className="text-[9px] font-mono text-zinc-500 uppercase block mb-1">Set Classification</span>
                  <span className="text-xs font-mono font-bold text-emerald-400">Warmup vs Working</span>
                </div>
                <div className="bg-[#0D0D0D] border border-[#252525] rounded-lg p-2.5 sm:p-3">
                  <span className="text-[9px] font-mono text-zinc-500 uppercase block mb-1">Preset Note Ingest</span>
                  <span className="text-xs font-mono font-bold text-white">One-Tap Chips</span>
                </div>
                <div className="bg-[#0D0D0D] border border-[#252525] rounded-lg p-2.5 sm:p-3">
                  <span className="text-[9px] font-mono text-zinc-500 uppercase block mb-1">Keyboard Layout</span>
                  <span className="text-xs font-mono font-bold text-[#CCFF00]">Drift Resilient</span>
                </div>
                <div className="bg-[#0D0D0D] border border-[#252525] rounded-lg p-2.5 sm:p-3">
                  <span className="text-[9px] font-mono text-zinc-500 uppercase block mb-1">Navigation Listener</span>
                  <span className="text-xs font-mono font-bold text-white">Instant Refresh</span>
                </div>
              </div>
            </div>

            {/* Bento Card 4: Interactive TTV Graph */}
            <div className="md:col-span-7 bg-[#141414] border border-[#252525] rounded-xl p-5 sm:p-8 flex flex-col justify-between transition-all hover:border-[#CCFF00]/40 group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-36 h-36 bg-[#CCFF00]/5 rounded-full blur-3xl pointer-events-none"></div>
              ...
              <div>
                <div className="flex items-center space-x-2 text-glow mb-4">
                  <Gauge className="w-5 h-5 text-[#CCFF00]" />
                  <span className="text-xs font-mono tracking-widest uppercase text-[#CCFF00]">High-Fidelity Chronological Analytics</span>
                </div>
                <h3 className="text-xl font-display font-medium text-white mb-2">Chronological Tonnage Analytics</h3>
                <p className="text-sm text-[#9A9A9A] leading-relaxed max-w-md mb-6">
                  Plot multi-set database metrics onto structured weekly vectors seamlessly. Monitor overall adaptive strength trajectories via custom embedded area line graph visualizations.
                </p>
              </div>
              ...
              <div className="bg-[#0D0D0D] border border-[#252525] rounded-lg p-3 sm:p-4 font-mono text-[10px] space-y-2">
                <div className="flex justify-between text-zinc-500 border-b border-[#1A1A1A] pb-2">
                  <span>WEEKLY TONNAGE WORKLOAD METRIC PACKETS</span>
                  <span className="text-emerald-400">CALCULATED</span>
                </div>
                <div className="space-y-1.5">
                  <div className="flex justify-between">
                    <span className="text-white">WEEK_3_VOLUME_TONNAGE</span>
                    <span className="text-[#CCFF00]">3,840 kg / STRENGTH SPIKE</span>
                  </div>
                  <div className="w-full bg-[#1A1A1A] h-1.5 rounded-full overflow-hidden">
                    <div className="w-[88%] bg-[#CCFF00] h-full"></div>
                  </div>
                </div>
                <div className="space-y-1.5 pt-1">
                  <div className="flex justify-between">
                    <span className="text-white">WEEK_2_VOLUME_TONNAGE</span>
                    <span className="text-zinc-400">3,420 kg</span>
                  </div>
                  <div className="w-full bg-[#1A1A1A] h-1.5 rounded-full overflow-hidden">
                    <div className="w-[75%] bg-[#CCFF00]/60 h-full"></div>
                  </div>
                </div>
                <div className="space-y-1.5 pt-1">
                  <div className="flex justify-between">
                    <span className="text-white">WEEK_1_VOLUME_TONNAGE</span>
                    <span className="text-zinc-400">3,100 kg</span>
                  </div>
                  <div className="w-full bg-[#1A1A1A] h-1.5 rounded-full overflow-hidden">
                    <div className="w-[65%] bg-[#CCFF00]/40 h-full"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="biometrics" className="py-16 sm:py-24 px-4 sm:px-6 border-t border-[#1C1C1C] relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <div className="flex-1 space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <h2 className="font-display font-medium text-3xl sm:text-4xl text-white tracking-tight">
              Biomechanical Training Focus Visualizer
            </h2>
            <p className="text-[#9A9A9A] text-sm sm:text-base leading-relaxed max-w-xl">
              Interact with our custom vector coordinate representation model. MacroFlux runs on absolute layout rendering precision, optimizing interactive mathematical graphs to map your physical hypertrophy transformations accurately.
            </p>
            <div className="space-y-3 font-mono text-xs text-[#9A9A9A] text-left">
              <div className="flex items-center gap-2">
                <Check className="w-4 h-4 text-[#CCFF00] shrink-0" />
                <span>Responsive view convergence coordinates: X: {mousePos.x.toFixed(2)}, Y: {mousePos.y.toFixed(2)}</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-4 h-4 text-[#CCFF00] shrink-0" />
                <span>Synchronized layout listening buffers preserve processing efficiency limits.</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 flex items-center justify-center w-full">
            ...
            >
              ...
              {/* Kinetic Vector Turbine Graphic inside SVG */}
              <svg 
                className="w-full max-w-60 aspect-square select-none pointer-events-none transition-transform duration-300 ease-out"
                viewBox="0 0 200 200"
                style={{
                  transform: `perspective(600px) rotateY(${mousePos.x * 20}deg) rotateX(${-mousePos.y * 20}deg)`
                }}
              ...
              <div className="absolute bottom-4 left-6 right-6 flex justify-between items-center text-[10px] font-mono text-[#9A9A9A] tracking-wider uppercase">
                <span>Analytical Engine Orbit</span>
                <span className="text-[#CCFF00]">{treadmillActive ? 'ACCELERATED CADENCE' : 'IDLE VECTOR'}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-16 sm:py-24 px-4 sm:px-6 border-t border-[#1C1C1C] bg-[#0A0A0A] relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="text-xs font-mono text-[#CCFF00] uppercase tracking-widest block mb-2">WORKSPACE DEPLOYMENT</span>
            <h2 className="font-display font-medium text-3xl sm:text-4xl text-white tracking-tight">
              Perpetual Architecture Licenses.
            </h2>
            <p className="text-[#9A9A9A] text-sm sm:text-base leading-relaxed mt-4">
              Unlock the absolute hyper-focused metrics suite. Choose an operational volume license calibrated to your strength track.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-[#141414] border border-[#252525] rounded-xl p-5 sm:p-8 flex flex-col justify-between transition-all hover:border-[#252525]/80 relative group">
              <div>
                <span className="font-mono text-xs uppercase tracking-widest text-[#9A9A9A] block mb-2">LOCAL CONTEXT ENTRY</span>
                <h3 className="font-display font-bold text-2xl text-white mb-2">MacroFlux Free</h3>
                <p className="text-[#9A9A9A] text-xs leading-relaxed mb-6">Standard inline session log tracking with real-time target progress bars.</p>
                
                <div className="flex items-baseline mb-6 font-mono">
                  <span className="text-3xl font-extrabold text-[#CCFF00]">$0</span>
                  <span className="text-sm text-zinc-500 ml-1">/ PERPETUAL WORKSPACE</span>
                </div>

                <div className="space-y-3.5 text-xs text-[#BFBFBF]">
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Real-time Segmented Progress Bars</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>In-App Sheet Confirmation Modals</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Warmup set counter isolation guards</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#141414] border-2 border-[#CCFF00] rounded-xl p-5 sm:p-8 flex flex-col justify-between transition-all relative group neon-glow">
              ...
              <div>
                <span className="font-mono text-xs uppercase tracking-widest text-[#CCFF00] block mb-2">TOTAL TRAINING WORKLOAD POWER</span>
                <h3 className="font-display font-bold text-2xl text-white mb-2">MacroFlux Pro</h3>
                <p className="text-[#9A9A9A] text-xs leading-relaxed mb-6">Unrestricted chronological tonnage volume charting, past session notes caching, background-resilient countdown loops.</p>
                
                <div className="flex items-baseline mb-6 font-mono">
                  <span className="text-3xl font-extrabold text-[#CCFF00]">$12</span>
                  <span className="text-sm text-zinc-500 ml-1">/ LIFETIME COMMITMENT</span>
                </div>

                <div className="space-y-3.5 text-xs text-[#BFBFBF]">
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Weekly TTV Tonnage Area Charts</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Last session set note retrieval pipelines</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>One-tap quick-fill note string presets</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Drift-resilient AppState rest timers</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#141414] border border-[#252525] rounded-xl p-5 sm:p-8 flex flex-col justify-between transition-all hover:border-[#252525]/80 relative group">
              <div>
                <span className="font-mono text-xs uppercase tracking-widest text-[#9A9A9A] block mb-2">STATION SCALING INTEGRATION</span>
                <h3 className="font-display font-bold text-2xl text-white mb-2">Syndicate Engine</h3>
                <p className="text-[#9A9A9A] text-xs leading-relaxed mb-6">Engineered explicitly for athletic teams, personal coaching hubs, and enterprise performance tracks.</p>
                
                <div className="flex items-baseline mb-6 font-mono">
                  <span className="text-3xl font-extrabold text-[#CCFF00]">Custom</span>
                  <span className="text-sm text-zinc-500 ml-1">/ SLA DEPLOYMENT</span>
                </div>

                <div className="space-y-3.5 text-xs text-[#BFBFBF]">
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Multi-athlete provisioning constraints</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Direct localized storage data exports</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-[#CCFF00]" />
                    <span>Custom variant biomechanical scripts</span>
                  </div>
                </div>
              </div>
      ...
      <footer className="border-t border-[#1C1C1C] py-12 px-4 sm:px-6 bg-[#0D0D0D]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between text-xs text-[#9A9A9A] font-mono gap-6">
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-1">
              <span className="text-white font-bold">MacroFlux</span>
              <span className="text-[#CCFF00]">Overload Workspace</span>
            </div>
            <span>© 2026 MacroFlux Corp.</span>
          </div>
          <div className="flex items-center space-x-6">
